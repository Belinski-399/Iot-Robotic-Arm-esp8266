...
input {
  ...
  <body>
    ...
    <div class="rightside wfxc">
      <div class="slidecontainer">
      <label>Cima - Baixo</label>
        <input type="range" min="0" max="90" value="90" id="myRange2"/>
      </div>
      
      <div class="slidecontainer">
      <label>Frente - volta</label>
        <input type="range" min="0" max="60" value="90" id="myRange3"/>
      </div>
    </div>
    </div>
